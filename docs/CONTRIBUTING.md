...
* Clone your fork
    ...
    `git clone https://github.com/YOUR_USERNAME/spikey`
    
    `cd neuro`
* Add this repository as the upstream

    `git remote add upstream https://github.com/adamltyson/spikey`
...
#### Formatting
`spikey` uses [Black](https://github.com/python/black) to ensure a consistent 
...
#### Testing
`spikey` uses [pytest](https://docs.pytest.org/en/latest/) for testing. Please 
...
Hence to release a new version of `spikey`, use either GitHub, or the git 
